...
const TeamContactInfo = ({ data, setData, setView }) => {
  ...
  const { current: validationSchema } = useRef(
    yup.object({
      ...
      city: yup
        .string()
        .test('city', tCommon('validation.required'), (value) => !!(value || '').replace(/\s/g, ''))
        .required(tCommon('validation.required'))
        .nullable(),
      web_site: yup
        .string()
    ...
    <Form onSubmit={formik.handleSubmit}>
      <div className='auth-wrapper__input'>
        ...
        <TextField
          ...
          placeholder={tAuth('team.teamTitle')}
          variant='outlined'
      ...
      >
        <div className='auth-wrapper__input'>
          <p className='auth-title__input'>{tAuth('common.country')}</p>
          <Autocomplete
        ...
        <div className='auth-wrapper__input'>
          <p className='auth-title__input'>{tAuth('common.city')}</p>
          <Autocomplete
            noOptionsText={tAuth('common.noOptionsText')}
      ...
      <div className='auth-wrapper__input'>
        ...
        <TextField
          ...
          name='web_site'
          onChange={formik.handleChange}
          placeholder={tAuth('common.webSite')}
          variant='outlined'
      ...
      >
          ...
          >
            {(inputProps) => (
              <TextField
                ...
                error={formik.touched.phone_coach && Boolean(formik.errors.phone_coach)}
                helperText={formik.touched.phone_coach && formik.errors.phone_coach}
              />
            )}
          </InputMask>
        </div>
        <div className='auth-wrapper__input'>
          ...
          <TextField
            ...
            error={formik.touched.email_coach && Boolean(formik.errors.email_coach)}
