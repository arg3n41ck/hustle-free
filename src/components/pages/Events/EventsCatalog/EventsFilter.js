...
function EventsFilter() {
  ...
  const sportTypesValue =
    sportTypes.length && sportTypes.find((type) => type.name === query.get('type_sport'))

  const countriesValue =
    countries.length && countries.find((type) => type.name === query.get('country'))
        ...
        <Filters>
          ...
          <LocalizationProvider locale={ru} dateAdapter={AdapterDateFns}>
            <DesktopDatePicker
              ...
              value={fromDate}
              onChange={(value) => {
                handleDateRange('date_start', value && format(value, 'yyyy-MM-dd'))
              }}
              clearable
            ...
            <DesktopDatePicker
              ...
              onChange={(value) => {
                handleDateRange('date_end', value && format(value, 'yyyy-MM-dd'))
              }}
              clearable
              clearText={tEvents('events.filter.putAway')}
              inputFormat='dd/MM/yyyy'
