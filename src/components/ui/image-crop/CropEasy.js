...
import { Box, Button, DialogActions, DialogContent, Modal, Slider, Typography } from '@mui/material'
import React, { useState } from 'react'
import Cropper from 'react-easy-crop'
import getCroppedImg from '../../../utils/cropImage'

const CropEasy = ({ photoURL, openCrop, setOpenCrop, setPhotoURL, setFile }) => {
