      ...
      >
        <div className='auth-container'>
          ...
          <div className='auth-wrapper'>
            {sm && toggleInfoModal ? (
              <InfoEmailBlock>
                <InfoEmailBlockTitle weight={600}>{tAuth('toast.perfect')}</InfoEmailBlockTitle>
                <InfoEmailBlockTitle weight={400}>{`${tAuth('toast.sendToEmailP1')} ${
                  formik.values.email
                } ${tAuth('toast.sendToEmailP2')}`}</InfoEmailBlockTitle>
              </InfoEmailBlock>
            ) : (
              <>
...
const InfoEmailBlockTitle = styled.p`
  font-family: 'Inter';
  font-style: normal;
...
const InfoEmailBlock = styled.div`
  width: 100%;
  background: #191a1f;
